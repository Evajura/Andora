...
export const familyArticles = {
  ...
  'respite-care-planning-houston': {
    title: 'Respite Care in Houston: A Family Planning Checklist',
    description: 'Planning respite care in Houston? Use Andora’s checklist for schedules, a clear caregiver handoff, household routines, and backup contacts.',
    source: { label: 'National Institute on Aging: Sharing caregiving responsibilities', url: 'https://www.nia.nih.gov/health/caregiving/sharing-caregiving-responsibilities' },
    sections: [
      {
        heading: 'How do you arrange respite care at home?',
        text: [
          'Start with the dates you need a break, the tasks someone must cover, and your loved one’s daily routine. Ask an agency to confirm that the requested support and staffing are available. Before the visit, agree on a handoff, emergency contacts, costs, and who will answer questions while you are away.',
          'Planning respite care in Houston can begin with an ordinary need: a work commitment, a personal appointment, a weekend away, or time to rest. You do not have to wait for a crisis to ask what help is possible. The National Institute on Aging includes regular respite among the ways families can share caregiving responsibilities. This Andora checklist focuses on the practical details of arranging a visit at home, so the family can discuss expectations clearly rather than trying to remember everything at the doorway.',
        ],
      },
      {
        heading: '1. Choose the time you actually need covered',
        text: [
          'Write down the start and end times, not just the day of the week. Include the time needed for the first handoff. If travel is involved, talk about what happens if your return is delayed. Ask about minimum visits and whether an extension would require advance confirmation or a different caregiver.',
          'For example, a family arranging an afternoon appointment may need help with lunch and companionship. A weekend trip may involve morning routines, evening support, and overnight coverage. Those visits should not be quoted or staffed as though they are the same service.',
        ],
        bullets: [
          'Preferred dates and exact coverage hours.',
          'Personal care, meals, mobility, and companionship tasks.',
          'Any nursing needs to discuss separately with the clinical team.',
          'A realistic plan for a late return or a change in schedule.',
        ],
      },
      {
        heading: '2. Prepare a short, useful handoff',
        text: [
          'A simple routine sheet can help the conversation stay focused. Include preferred meals, familiar activities, communication preferences, and where everyday supplies are kept. Ask the agency how medication information and other sensitive care instructions should be provided. A general note to “give medicines” is not a substitute for an agreed care plan and an appropriately qualified worker.',
          'Include your loved one in planning as much as they wish and are able. A favorite conversation topic, a familiar radio program, or time tending a planter may be a more welcoming introduction than a long list of restrictions. Discuss how the caregiver should respond if an activity is declined or the person seems uncomfortable.',
        ],
      },
      {
        heading: '3. Set up access, communication, and backup contacts',
        text: [
          'For a Downtown apartment, confirm visitor entry, parking, and elevator arrangements. For a home in Memorial, River Oaks, Richmond, or another Houston-area neighborhood, explain door access, pets, and where the handoff will take place. Share access codes securely, not through public messages or a general website inquiry.',
          'Agree on who can receive updates and who can authorize a schedule change. Leave a backup family contact in case you are unavailable. Ask what happens if the scheduled caregiver is delayed or cannot attend, and keep the agency’s contact instructions where they can be found.',
        ],
        bullets: [
          'Primary family contact and an agreed backup contact.',
          'Agency contact and the process for after-hours questions.',
          'A clear handoff location and secure home-entry instructions.',
          'An emergency plan; for a medical emergency, call 911.',
        ],
      },
      {
