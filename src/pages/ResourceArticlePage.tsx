...
const articles: Record<string, Article> = {
  ...
  'private-duty-home-care-explained': { title: 'What Is Private Duty Home Care? A Houston Family Guide', description: 'A practical introduction to private duty home care, the questions to ask, and how Houston families can begin planning support at home.', source: { label: 'National Institute on Aging: Aging in place', url: 'https://www.nia.nih.gov/health/aging-place-growing-older-home' }, sections: [
    ...
    { heading: 'Choose a plan that is clear and realistic', text: ['Ask for a written explanation of the service, schedule, rate structure, and any steps required before care begins. If a family is considering overnight or continuous coverage, ask how shifts, handoffs, and backup coverage are arranged. If the situation follows a hospital stay, ask the discharge team which needs should be addressed by clinical providers and which may be part of daily-living support.', 'Andora can discuss private duty care needs with families across Greater Houston. Call (832) 679-3716 to talk through the preferred schedule, location, and current availability.'] },
  ] },
